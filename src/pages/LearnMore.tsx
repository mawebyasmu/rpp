      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            Generator RPP Madrasah dirancang sebagai alat bantu untuk guru dalam menyusun RPP yang sesuai standar kurikulum. 
        ...
        <Card className="mb-8 border-primary/20 bg-primary/5">
          <CardHeader>
            <CardTitle className="text-2xl flex items-center gap-2">
              ...
              Cara Menggunakan Generator RPP
            </CardTitle>
          </CardHeader>
          <CardContent>
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  Lengkapi form dengan informasi madrasah, mata pelajaran, dan capaian pembelajaran
                </p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                <h3 className="font-semibold mb-2">Generate AI</h3>
                <p className="text-sm text-muted-foreground">
                  AI akan memproses dan menghasilkan RPP sesuai standar kurikulum Madrasah
                </p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Review hasil RPP, sesuaikan jika perlu, dan download dalam format .docx
                </p>
              </div>
            </div>
          </CardContent>
        ...
        {/* CTA Section */}
        <div className="text-center">
          <h2 className="text-3xl font-bold mb-4">Siap Mencoba Generator RPP?</h2>
          <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
            Mulai buat RPP berkualitas untuk Madrasah Anda sekarang. Gratis dan mudah digunakan!
          </p>
